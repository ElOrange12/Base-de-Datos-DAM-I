...
<html>
	<head>
		<style>
			...
			nav{background:darkorange; padding:20px; gap:20px; flex:1; display:flex; flex-direction:column; gap:20px;}
			nav a {background:white; color:darkorange; text-decoration:none; padding:10px}
      		main{padding:20px; flex:4;}
      		table td{padding:10px}
      		table{border:2px solid darkorange; width:100%;}
      		th {background:darkorange; color:white; padding:10px;}
		</style>
	</head>
	<body>
		<?php
		...
		<nav>
			<?php
				// Ahora lo que quiero es un listado en la base de datos
